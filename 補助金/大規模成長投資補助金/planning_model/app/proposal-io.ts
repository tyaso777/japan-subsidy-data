...
:root{--ink:#173126;--muted:#607169;--green:#244a3a;--soft:#e7f0ea;--line:#d7dfda;--paper:#f7f5ef}
*{box-sizing:border-box}
html{scroll-padding-top:74px}
body{margin:0;background:var(--paper);color:var(--ink);font-family:"Yu Gothic UI","Yu Gothic",sans-serif}
...
.cover h1{margin:5px 0 12px;font-family:"Yu Mincho",serif;font-size:32px}
...
section>h2{position:sticky;top:0;z-index:30;margin:-1px -1px 15px;padding:13px 1px 11px;background:#fff;border-bottom:1px solid var(--line);font-family:"Yu Mincho",serif;font-size:22px}
