...
const driverNames: Partial<Record<keyof Drivers, string>> = {
  projectCogsRateWhenSalesZero: "補助事業 原価率（基準年後初年度）",
  otherCogsRateWhenSalesZero: "ベース事業 原価率（基準年後初年度）",
  projectCogsRateToBase: "補助事業 原価率（設備導入期間初年度）",
  otherCogsRateToBase: "ベース事業 原価率（設備導入期間初年度）",
  ...
  projectMarketGrowth: "7-20 市場伸び率（年あたり）", projectSalesGrowthToBase: "補助事業 売上成長率（設備導入期間）", projectFirstYearSales: "補助事業 売上高（設備導入初年度）", projectBaseYearSales: "補助事業 売上高（基準年度）", projectCogsImprovementToBase: "補助事業 原価率 年当たり改善ポイント（設備導入期間）", projectPayGrowthToBase: "補助事業 1人当たり給与支給総額上昇率（設備導入期間）", projectHeadcountGrowthToBase: "補助事業 常時使用する従業員数の成長率（設備導入期間）", projectSgaImprovementToBase: "補助事業 その他販管費率改善ポイント（設備導入期間）", projectOfficerPayGrowthToBase: "役員1人当たり給与支給総額上昇率（設備導入期間）", otherSalesGrowthToBase: "ベース事業 売上成長率（設備導入期間）", otherCogsImprovementToBase: "ベース事業 原価率 年当たり改善ポイント（設備導入期間）", otherPayGrowthToBase: "ベース事業1人当たり給与支給総額の年平均上昇率（設備導入期間）", otherHeadcountGrowthToBase: "ベース事業 常時使用する従業員数の成長率（設備導入期間）", otherSgaImprovementToBase: "ベース事業 その他販管費率改善ポイント（設備導入期間）", projectSalesGrowth: "補助事業 売上成長率（基準年度後）", otherSalesGrowth: "ベース事業 売上成長率（基準年度後）", projectCogsImprovementAfterBase: "補助事業 原価率 年当たり改善ポイント（基準年後）", otherCogsImprovement: "ベース事業 原価率 年当たり改善ポイント（基準年後）", projectPayGrowth: "補助事業1人当たり給与支給総額の年平均上昇率", otherPayGrowth: "ベース事業1人当たり給与支給総額の年平均上昇率（基準年度後）", projectHeadcountGrowth: "補助事業 常時使用する従業員数の成長率", otherHeadcountGrowth: "ベース事業 常時使用する従業員数の成長率（基準年度後）", projectSgaRateEnd: "補助事業 その他販管費率改善ポイント（基準年後）", otherSgaRateEnd: "ベース事業 その他販管費率改善ポイント（基準年後）", projectOfficerPayGrowth: "役員1人当たり給与支給総額の年平均上昇率", investment: "補助事業投資額", subsidy: "申請補助金額", localBenchmark: "ローカルベンチマーク",
};
...
const fixedOutputDriverKeys = new Set<keyof Drivers>([
  "investment", "subsidy", "projectFirstYearSales", "projectBaseYearSales", "projectMarketGrowth",
