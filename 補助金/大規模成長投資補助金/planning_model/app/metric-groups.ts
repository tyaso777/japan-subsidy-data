...
export type MetricGroupKey = "companySales" | "projectSales" | "laborProductivity" | "employeePay" | "officerPay";
...
export const metricLinkGroups: MetricLinkGroup[] = [
  ...
  { key: "officerPay", label: "役員給与", rateKey: "officerPayCagr", amountKey: "officerPayIncrease", rateLabel: "1人当たり給与上昇率", amountLabel: "給与支給総額増加額", relation: "給与支給総額と役員数から連動" },
];
