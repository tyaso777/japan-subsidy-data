...
assert(dashboardHtml.includes('data-section="methodology"><summary>公式15指標：算出可否・計算方法・統計量</summary>') && dashboardHtml.includes("const OFFICIAL_METRICS=[") && dashboardHtml.includes("function publicStats(field)"), "dashboard must document all 15 official metrics and calculate public-value statistics");
