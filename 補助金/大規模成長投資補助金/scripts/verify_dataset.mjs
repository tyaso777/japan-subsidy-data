...
assert(dashboardHtml.includes("function exportRows(){if(!boxSelectionActive)return filtered") && dashboardHtml.includes("const ids=new Set(boxSelectionIds)") && dashboardHtml.includes("'company','pdf_url',xmetric.value"), "CSV export must include PDF URLs and restrict rows to the active scatter or histogram selection");
