...
assert(dashboardHtml.includes('<hr class="filter-divider"><section class="sidebar-companies" id="selectionPanel"') && dashboardHtml.includes('.sidebar-companies .selection-list{height:280px') && dashboardHtml.includes('id="centerFilterSummary"'), "company list must be fixed-height in the left sidebar and show central filter conditions");
