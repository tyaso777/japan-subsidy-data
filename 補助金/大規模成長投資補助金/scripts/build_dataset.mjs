...
<main class="layout"><aside class="case-sidebar"><div class="case-sort"><span>並び順</span><button id="sortCompany" class="active" type="button">会社名順</button><button id="sortFile" type="button">ファイル名順</button></div><div id="caseList" class="case-list"></div></aside><article id="detail" class="detail"><div class="empty">左の案件を選択してください</div></article><aside class="pdf-pane"><div class="pdf-bar"><span id="pdfLabel">ローカルPDF</span><a id="pdfOpen" target="_blank" rel="noopener">ローカルPDFを開く</a><a id="pdfOfficial" target="_blank" rel="noopener">公式PDF</a></div><iframe id="pdfFrame" title="ローカルPDF"></iframe></aside></main>
<script>
